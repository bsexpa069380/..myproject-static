...
window.addEventListener('DOMContentLoaded', function() {
	...
	var img1 = document.getElementById('enter-img-1');
	var img2 = document.getElementById('enter-img-2');
	if (!overlay || !img1 || !img2) return;
	// 第一張zoom out
	setTimeout(function() {
	...
	setTimeout(function() {
	  ...
	  img2.style.transform = 'scale(1)'; // 第二張zoom out
	  setTimeout(function() {
